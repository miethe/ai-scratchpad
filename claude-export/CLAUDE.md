...
Delegate documentation to appropriate agents:

```markdown
# 90% of documentation (fast, cost-effective)
Task("documentation-writer", "Create README for new module")
Task("documentation-writer", "Document authentication endpoints")

# Complex multi-system docs (rare)
Task("documentation-complex", "Document integration of 5+ services")

# Planning only (never writing)
Task("documentation-planner", "Analyze what docs are needed")
```
